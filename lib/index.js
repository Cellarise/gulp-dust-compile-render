 ...
 * @param {string} [opts.opts.partialsGlob] A glob pattern for the dust templates to be loaded as partials
 * that can be referenced in dust templates
 * @param {boolean} [opts.opts.preserveWhitespace] Preserve whitespace in output
 * @param {boolean} [opts.opts.ignoreUndefinedTags] Ignore dust tags undefined in the context object.
